...
# Created by write_sdc on Sat Nov 14 17:07:23 2020
...
create_clock [get_ports clk]  -name my_clk  -period 2.65  -waveform {0 1.325}
...
set_input_delay -clock my_clk  -max 0.5  [get_ports {a0a1[11]}]
set_input_delay -clock my_clk  -max 0.5  [get_ports {a0a1[10]}]
set_input_delay -clock my_clk  -max 0.5  [get_ports {a0a1[9]}]
set_input_delay -clock my_clk  -max 0.5  [get_ports {a0a1[8]}]
set_input_delay -clock my_clk  -max 0.5  [get_ports {a0a1[7]}]
set_input_delay -clock my_clk  -max 0.5  [get_ports {a0a1[6]}]
set_input_delay -clock my_clk  -max 0.5  [get_ports {a0a1[5]}]
set_input_delay -clock my_clk  -max 0.5  [get_ports {a0a1[4]}]
set_input_delay -clock my_clk  -max 0.5  [get_ports {a0a1[3]}]
set_input_delay -clock my_clk  -max 0.5  [get_ports {a0a1[2]}]
set_input_delay -clock my_clk  -max 0.5  [get_ports {a0a1[1]}]
set_input_delay -clock my_clk  -max 0.5  [get_ports {a0a1[0]}]
set_input_delay -clock my_clk  -max 0.5  [get_ports {a1a1[11]}]
set_input_delay -clock my_clk  -max 0.5  [get_ports {a1a1[10]}]
set_input_delay -clock my_clk  -max 0.5  [get_ports {a1a1[9]}]
set_input_delay -clock my_clk  -max 0.5  [get_ports {a1a1[8]}]
set_input_delay -clock my_clk  -max 0.5  [get_ports {a1a1[7]}]
set_input_delay -clock my_clk  -max 0.5  [get_ports {a1a1[6]}]
set_input_delay -clock my_clk  -max 0.5  [get_ports {a1a1[5]}]
set_input_delay -clock my_clk  -max 0.5  [get_ports {a1a1[4]}]
set_input_delay -clock my_clk  -max 0.5  [get_ports {a1a1[3]}]
set_input_delay -clock my_clk  -max 0.5  [get_ports {a1a1[2]}]
set_input_delay -clock my_clk  -max 0.5  [get_ports {a1a1[1]}]
set_input_delay -clock my_clk  -max 0.5  [get_ports {a1a1[0]}]
set_input_delay -clock my_clk  -max 0.5  [get_ports {a1a2[11]}]
...
set_input_delay -clock my_clk  -max 0.5  [get_ports {a1b0[11]}]
set_input_delay -clock my_clk  -max 0.5  [get_ports {a1b0[10]}]
set_input_delay -clock my_clk  -max 0.5  [get_ports {a1b0[9]}]
set_input_delay -clock my_clk  -max 0.5  [get_ports {a1b0[8]}]
set_input_delay -clock my_clk  -max 0.5  [get_ports {a1b0[7]}]
set_input_delay -clock my_clk  -max 0.5  [get_ports {a1b0[6]}]
set_input_delay -clock my_clk  -max 0.5  [get_ports {a1b0[5]}]
set_input_delay -clock my_clk  -max 0.5  [get_ports {a1b0[4]}]
set_input_delay -clock my_clk  -max 0.5  [get_ports {a1b0[3]}]
set_input_delay -clock my_clk  -max 0.5  [get_ports {a1b0[2]}]
set_input_delay -clock my_clk  -max 0.5  [get_ports {a1b0[1]}]
set_input_delay -clock my_clk  -max 0.5  [get_ports {a1b0[0]}]
...
set_input_delay -clock my_clk  -max 0.5  [get_ports {a1b2[11]}]
set_input_delay -clock my_clk  -max 0.5  [get_ports {a1b2[10]}]
set_input_delay -clock my_clk  -max 0.5  [get_ports {a1b2[9]}]
set_input_delay -clock my_clk  -max 0.5  [get_ports {a1b2[8]}]
set_input_delay -clock my_clk  -max 0.5  [get_ports {a1b2[7]}]
set_input_delay -clock my_clk  -max 0.5  [get_ports {a1b2[6]}]
set_input_delay -clock my_clk  -max 0.5  [get_ports {a1b2[5]}]
set_input_delay -clock my_clk  -max 0.5  [get_ports {a1b2[4]}]
set_input_delay -clock my_clk  -max 0.5  [get_ports {a1b2[3]}]
set_input_delay -clock my_clk  -max 0.5  [get_ports {a1b2[2]}]
set_input_delay -clock my_clk  -max 0.5  [get_ports {a1b2[1]}]
set_input_delay -clock my_clk  -max 0.5  [get_ports {a1b2[0]}]
