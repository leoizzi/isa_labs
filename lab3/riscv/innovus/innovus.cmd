...
#  Created on Sun Jan 17 11:15:06 2021                
#                                                     
#######################################################
...
getIoFlowFlag
setIoFlowFlag 0
floorPlan -coreMarginsBy die -site FreePDK45_38x28_10R_NP_162NW_34O -r 1.0 0.0.6 5.0 5.0 5.0 5.0
uiSetTool select
getIoFlowFlag
fit
...
placeDesign
zoomIn
gui_select -rect {4.958 -32.072 -35.659 -55.239}
fit
...
reset_parasitics
extractRC
rcOut -setload core.setload -rc_corner my_rc
rcOut -setres core.setres -rc_corner my_rc
rcOut -spf core.spf -rc_corner my_rc
rcOut -spef core.spef -rc_corner my_rc
